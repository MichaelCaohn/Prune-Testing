...
class BertTrainer(object):
    def __init__(self, model, optimizer, processor, scheduler, tokenizer, args, prune_mask, save_path):
        self.args = args
        self.model = model
        ...
        if not prune_mask:
            self.snapshot_path = os.path.join(save_path, "model_weight.pth")
        else:
            self.snapshot_path = os.path.join(save_path, "pruned_model_weight.pth")
