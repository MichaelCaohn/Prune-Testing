...
ALL_MODELS = sum((tuple(conf.pretrained_config_archive_map.keys()) for conf in (BertConfig, XLNetConfig, XLMConfig,
                                                                                RobertaConfig, DistilBertConfig, AlbertConfig)), ())
...
def main():
    ...
    parser.add_argument("--dirc_run", default=False, type=bool,
                        help="Whether to run directly.")
    ## Other parameters
    ...
    results = {}
    if args.do_eval:
        path = "/work/xuweinan/MNIST/google-research/test_prune_embeddings/examples/twng/bert-base-cased/model_after_retraining.ptmodel"
        modul = torch.load(path)
        accuracy = evaluate(args, modul, tokenizer)
        print(accuracy)
